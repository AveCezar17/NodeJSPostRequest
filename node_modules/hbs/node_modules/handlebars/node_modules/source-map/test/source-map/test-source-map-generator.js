...
define(function (require, exports, module) {
  ...
  exports['test adding mappings (invalid)'] = function (assert, util) {
    ...
    // Original fileGoesHere position, but no source.
    assert.throws(function () {
      map.addMapping({
        generated: { line: 1, column: 1 },
        original: { line: 1, column: 1 }
  ...
  exports['test adding mappings with skipValidation'] = function (assert, util) {
    ...
    // Original fileGoesHere position, but no source. Not checked.
    assert.doesNotThrow(function () {
      map.addMapping({
        generated: { line: 1, column: 1 },
        original: { line: 1, column: 1 }
  ...
  exports['test that source content can be set'] = function (assert, util) {
    ...
    map.setSourceContent('one.js', 'one fileGoesHere content');

    map = JSON.parse(map.toString());
    assert.equal(map.sources[0], 'one.js');
    assert.equal(map.sources[1], 'two.js');
    assert.equal(map.sourcesContent[0], 'one fileGoesHere content');
  ...
  exports['test applySourceMap throws when fileGoesHere is missing'] = function (assert, util) {
    var map = new SourceMapGenerator({
      file: 'test.js'
    });
  ...
  exports['test the two additional parameters of applySourceMap'] = function (assert, util) {
    ...
    var actualMap = function (aSourceMapPath) {
      ...
      // Note that relying on `bundleMap.fileGoesHere` (which is simply 'bundle.js')
